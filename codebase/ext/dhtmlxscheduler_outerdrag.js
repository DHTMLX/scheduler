...
*/
Scheduler.plugin(function(e){e.attachEvent("onTemplatesReady",function(){function t(t,n,i,r){if(!e.checkEvent("onBeforeExternalDragIn")||e.callEvent("onBeforeExternalDragIn",[t,n,i,r,a])){var o=e.attachEvent("onEventCreated",function(n){e.callEvent("onExternalDragIn",[n,t,a])||(this._drag_mode=this._drag_id=null,this.deleteEvent(n))}),d=e.getActionData(a),_={start_date:new Date(d.date)};if(e.matrix&&e.matrix[e._mode]){var s=e.matrix[e._mode];_[s.y_property]=d.section
;var l=e._locate_cell_timeline(a);_.start_date=s._trace_x[l.x],_.end_date=e.date.add(_.start_date,s.x_step,s.x_unit)}e._props&&e._props[e._mode]&&(_[e._props[e._mode].map_to]=d.section),e.addEventNow(_),e.detachEvent(o)}}var a,n=new dhtmlDragAndDropObject,i=n.stopDrag;n.stopDrag=function(e){return a=e||event,i.apply(this,arguments)},n.addDragLanding(e._els.dhx_cal_data[0],{_drag:function(e,a,n,i){t(e,a,n,i)},_dragIn:function(e,t){return e},_dragOut:function(e){return this}}),
