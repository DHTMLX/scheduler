...
for(var i in e)r.push({id:i,data:e[i],operation:this.getState(i)});return void this.serverProcessor._send(r,a,this)}var n=new dtmlXMLLoaderObject(this.afterUpdate,this,!0),d=this.serverProcessor+(this._user?getUrlSymbol(this.serverProcessor)+["dhx_user="+this._user,"dhx_version="+this.obj.getUserData(0,"version")].join("&"):"");"POST"!=this._tMode?n.loadXML(d+(-1!=d.indexOf("?")?"&":"?")+this.serialize(e,t)):n.loadXML(d,!0,this.serialize(e,t)),this._waitMode++}},e._updatesToParams=function(e){for(var t={},a=0;a<e.length;a++)t[e[a].id]=e[a].data;
